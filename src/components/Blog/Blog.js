...
const Blog = () => {
    return (
        <div>
            <h1 className='text-center text-rose-400 mt-5 text-3xl font-bold'>Simple Interview Question</h1>
            <div className='mt-5'>
                <h3 className='text-2xl font-bold'>Q1. What is the purspose of react route?</h3>
            ...
            <div className='mt-10'>
                <h3  className='text-2xl font-bold'>Q2. How does context API work?</h3>
            ...
            <div className='mt-10'>
                <h3 className='text-2xl font-bold'>Q3. What are the uses of useRef() react hook?</h3>
